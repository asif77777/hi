  ...
  return (
    <React.Fragment>
      {props.product.duka_approved ? (
        <span className="shop-card-product-features" title="shop Aproved">
          <DukaApproved />
          {props.showText ? (
            <span className="feature-text">shop  Aproved</span>
          ) : null}
        </span>
      ) : null}
      {props.product.fulfilled_by_duka ? (
        <span className="shop-card-product-features" title="Fullfiled By shop">
          <Warehouse />
          {props.showText ? (
            <span className="feature-text">Fullfiled By shop</span>
          ) : null}
        </span>
      ) : null}
